// ==========================================================
// SC CENTRAL V6 FINAL - BOOTSTRAP DA LOJA
...
(async () => {
  ...
  const KEYS = {
    ...
    categories: 'scCentralV6Categories'
  };
  ...
  try {
    ...
    console.warn('[SC V6] Iniciando fallback local:', error.message);
  }
  ...
  try {
    ...
    await loadScript('v6.js');
  } catch (error) {
    console.error('[SC V6] Erro ao iniciar interface:', error);
